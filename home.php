  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><span> E-learning </span></a>
      </div>
        ...
        <div class="row">
          <div class="banner-text text-center">
            <div class="text-border">
              <h2 class="text-dec">E - learning</h2>
            </div>
            <div class="intro-para text-center quote">
              <p class="big-text">An easy and organized way to explore the world of Learning through the window of our website</p>
  ...
  <footer id="footer" class="footer">
    <div class="container text-center">
      ...
      <div class="credits">
        ...
        -->
        Designed by <a href="https://abinash606.github.io/abhi03/">Abinash</a>
      </div>
    </div>
  </footer>
  <!--/ Footer-->
